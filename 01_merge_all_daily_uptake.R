...
pacman::p_load(data.table, readstata13, readr, lme4, dplyr, magrittr, stringr, openxlsx, ggplot2, gridExtra)
...
rm(gh5050_csa) #only going to look at country-sex
...
yougov <- fread(paste0('/FILEPATH/', Sys.Date(), '/FILEPATH/cleaned_yougov.csv'))
